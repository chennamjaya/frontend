pipeline {
  ...
  stages {
    ...
    stage('Release'){
      ...
      //}
      steps {
        sh 'docker build -t 851512651356.dkr.ecr.us-east-1.amazonaws.com/frontend:${TAG_NAME} .'
        ...
        sh 'docker push 851512651356.dkr.ecr.us-east-1.amazonaws.com/frontend:${TAG_NAME}'
      }
    }
  }
}